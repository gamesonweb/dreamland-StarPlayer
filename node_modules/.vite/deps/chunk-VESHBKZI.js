import {
  Scene
} from "./chunk-ANJBCSL2.js";
import {
  ApplyPostProcess,
  CubeMapToSphericalPolynomialTools,
  PostProcess,
  SphericalPolynomial
} from "./chunk-CLGP7AAI.js";
import {
  BaseTexture
...
var RGBDTextureTools = class {
  ...
  static ExpandRGBDTexture(texture) {
    ...
    const expandRGBDTexture = async () => {
      ...
      internalTexture.isReady = false;
      if (isWebGPU) {
        await import("./rgbdDecode.fragment-UWNGOJWW.js");
      } else {
        await import("./rgbdDecode.fragment-ZLTFV2TP.js");
      }
  ...
  static async EncodeTextureToRGBD(internalTexture, scene, outputTextureType = 0) {
    if (!scene.getEngine().isWebGPU) {
      await import("./rgbdEncode.fragment-3KSDEPNF.js");
    } else {
      await import("./rgbdEncode.fragment-RWP2GU6D.js");
    }
...
//# sourceMappingURL=chunk-VESHBKZI.js.map
