import {
  ...
  RenderingManager,
  SmartArray
} from "./chunk-LFVPLI6T.js";
import {
  PerfCounter
} from "./chunk-OL4XOEVO.js";
import {
  BaseTexture,
  Texture
} from "./chunk-75NH7WDS.js";
import {
  SerializationHelper
} from "./chunk-4WN62PQN.js";
import {
  __decorate,
  serialize,
  serializeAsColor4
} from "./chunk-MOEZ24D7.js";
import {
  Color3
} from "./chunk-S5KWWQBG.js";
import {
  Matrix,
  TmpVectors,
  ToLinearSpace,
  ...
  Vector3,
  _ObserveArray
} from "./chunk-FOUCMH2S.js";
import {
  HasStencilAspect,
  ThinEngine,
  WebGLDataBuffer,
  WebGLHardwareTexture
} from "./chunk-GHVFILMI.js";
import {
  EffectWrapper
} from "./chunk-CSFUEO6K.js";
import {
  GetClass,
  RegisterClass
...
var RenderTargetTexture = class _RenderTargetTexture extends Texture {
  ...
  isReadyForRendering() {
    if (!this._dumpToolsLoading) {
      ...
      import("./dumpTools-PQ5B5GVC.js").then((module) => this._dumpTools = module);
    }
...
var PostProcess = class _PostProcess {
  ...
  _gatherImports(useWebGPU = false, list) {
    if (useWebGPU && this._webGPUReady) {
      list.push(Promise.all([import("./postprocess.vertex-OZ2WXGOY.js")]));
    } else {
      list.push(Promise.all([import("./postprocess.vertex-VUZ4ZCJ6.js")]));
    }
  }
  /**
...
ThinEngine.prototype.createPrefilteredCubeTexture = function(rootUrl, scene, lodScale, lodOffset, onLoad = null, onError = null, format, forcedExtension = null, createPolynomials = true) {
  const callback = async (loadData) => {
    ...
    const { DDSTools } = await import("./dds-IIIEFIXQ.js");
    const textures = [];
...
var ThinPassPostProcess = class _ThinPassPostProcess extends EffectWrapper {
  _gatherImports(useWebGPU, list) {
    if (useWebGPU) {
      ...
      list.push(Promise.all([import("./pass.fragment-XE3X5HM3.js")]));
    } else {
      list.push(Promise.all([import("./pass.fragment-55ZSIEYH.js")]));
    }
...
var ThinPassCubePostProcess = class _ThinPassCubePostProcess extends EffectWrapper {
  _gatherImports(useWebGPU, list) {
    if (useWebGPU) {
      this._webGPUReady = true;
      list.push(Promise.all([import("./passCube.fragment-HEBTPYH7.js")]));
    } else {
      list.push(Promise.all([import("./passCube.fragment-OB5UWZSE.js")]));
    }
    super._gatherImports(useWebGPU, list);
  }
  /**
...
var ProcessAsync = async (texture, width, height, face, lod) => {
  ...
  if (!engine.isWebGPU) {
    if (texture.isCube) {
      await import("./lodCube.fragment-ZEQWQ75S.js");
    } else {
      await import("./lod.fragment-OFCUM6YX.js");
    }
  } else {
    if (texture.isCube) {
      await import("./lodCube.fragment-CGGMFCNA.js");
    } else {
      await import("./lod.fragment-KCRBLH2C.js");
    }
  }
  let lodPostProcess;
  if (!texture.isCube) {
...
//# sourceMappingURL=chunk-CLGP7AAI.js.map
